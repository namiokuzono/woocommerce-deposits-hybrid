...
if ( ! class_exists( 'WC_Deposits_Hybrid_Settings' ) ) {
    /**
...
// Only return an instance if the class was just defined
if ( ! isset( $GLOBALS['wc_deposits_hybrid_settings'] ) ) {
    $GLOBALS['wc_deposits_hybrid_settings'] = new WC_Deposits_Hybrid_Settings();
}

return $GLOBALS['wc_deposits_hybrid_settings']; 